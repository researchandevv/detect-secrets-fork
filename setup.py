...
setup(
    ...
    version=VERSION,
    description='Tool for detecting secrets in the codebase (fork with additional detectors)',
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Yelp, Inc.',
    author_email='opensource@yelp.com',
    url='https://github.com/researchandevv/detect-secrets-fork',
    download_url='https://github.com/researchandevv/detect-secrets-fork/archive/{}.tar.gz'.format(VERSION),
